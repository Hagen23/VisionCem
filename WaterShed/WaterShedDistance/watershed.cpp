...
int main(int argc, char** argv)
{
	...
	cv::threshold(bw, bw, 20, 255, CV_THRESH_BINARY_INV);
//	cv::threshold(bw, bw, 20, 255, CV_THRESH_BINARY);
	cv::imshow("bw", bw);

	// Perform the distance transform algorithm
	cv::Mat dist;
	cv::distanceTransform(bw, dist, CV_DIST_L1, distanceMask);
